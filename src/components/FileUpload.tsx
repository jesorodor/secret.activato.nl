        ...
        return (
            ...
            >
                <div className="flex items-center justify-center space-x-3">
                    ...
                    <Link
                        to="/login"
                        className="inline-block px-3 py-1.5 bg-accent-secondary hover:bg-accent-secondary-hover text-white text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg"
                    >
